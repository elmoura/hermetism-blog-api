...
exports.CreateAuthorController = void 0;
class CreateAuthorController {
    ...
    handle(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            const { firstName, lastName, whatsapp, email, password, bio, valueOfHour, areas } = request.body;
            const createdAuthor = yield this.createAuthorUseCase.execute({
                firstName,
                lastName,
                whatsapp,
                email,
